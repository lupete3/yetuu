...
<div class="container">
    ...
    <table class="info-table">
        ...
        <tr>
            ...
            <td>{{ $crop->crop_id }}</td>
            <th>Sowing Date</th>
            <td>{{ $crop->planting_date ? \Carbon\Carbon::parse($crop->planting_date)->format('d/m/Y') : 'Not defined' }}</td>
        </tr>
        <tr>
            <th>Variety</th>
        ...
        <tr>
            ...
            <td>
                @if($crop->photo)
                    <div class="mt-3">
                        <img src="{{ asset('storage/app/public/' . $crop->photo) }}" alt="Crop Photo" class="img-thumbnail" width="100">
                    </div>
                @endif
            </td>
            <th>Created At</th>
