                        ...
                        <div class="card">
                            <div class="card-header">
                                ...
                                <div class="card-header-action">
                                    <a href="{{ route('crop-management.create') }}"
                                        class="btn btn-icon icon-left btn-success">
                                        <i class="fas fa-plus"></i> Add
                                    </a>
                                    <a href="{{ route('crop-management.export_excel') }}"
                                        class="btn btn-icon icon-left btn-success">
                                        <i class="fas fa-download"></i> Export to Excel
                                    </a>
                                    <a href="{{ route('crop-management.print') }}"
                                        class="btn btn-icon icon-left btn-success">
                                                    ...
                                                    <td>
                                                        <div class="dropdown">
                                                            ...
                                                            <div class="dropdown-menu dropdown-menu-right">
                                                                <a target="_blank"
                                                                    href="{{ route('crop-management.show', $crop->id) }}"
                                                                    class="dropdown-item has-icon">
                                                                    <i class="far fa-eye text-info"></i> View
                                                                </a>
                                                                <a href="{{ route('crop-management.edit', $crop->id) }}"
                                                                    class="dropdown-item has-icon">
                                                                    <i class="far fa-edit text-success"></i> Edit
                                                                </a>

                                                                <form action="{{ route('crop-management.destroy', $crop->id) }}"
                                                                    method="post">
                                                                    @csrf
                                                                    @method('DELETE')
