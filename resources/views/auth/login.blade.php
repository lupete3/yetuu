    ...
    <div class="login-container row">
        ...
        <div class="col-md-4 p-5">
            <div class="text-center">
                <img src="{{ asset('public/logos/1725016789_Sans titre-1(1).png') }}" alt="Logo" class="form-logo">
            ...
            <div class="text-right mt-4">
                ...
                @endif 
                <p class="mt-2 text-left">Don’t have an account? <a href="{{ route('register') }}" class="text-decoration-none text-success">Sign Up</a></p>
            </div>
        </div>
    </div>
