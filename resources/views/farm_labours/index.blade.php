                        ...
                        <div class="card">
                            <div class="card-header">
                                ...
                                <div class="card-header-action">
                                    ...
                                    <a href="{{ route('farmlabours.export_excel') }}"
                                                    ...
                                                    <td>
                                                        <div class="dropdown">
                                                            ...
                                                            <div class="dropdown-menu dropdown-menu-right">
                                                                <a target="_blank"
                                                                    href="{{ route('farmlabours.show', $farmlabour->id) }}"
                                                                    class="dropdown-item has-icon">
                                                                    <i class="far fa-eye text-info"></i> View
                                                                </a>
                                                                <a href="{{ route('farmlabours.edit', $farmlabour->id) }}"
                                                                    class="dropdown-item has-icon">
                                                                    <i class="far fa-edit text-success"></i> Edit
                                                                </a>

                                                                <form
                                                                    action="{{ route('farmlabours.destroy', $farmlabour->id) }}"
                                                                    method="post">
                                                                    @csrf
                                                                    @method('DELETE')
