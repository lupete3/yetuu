            ...
            <div class="section-body">
                <div class="row">
                    <div class="col-12 col-md-12 col-lg-12">
                        ...
                        <div class="card">
                            <form method="post" action="{{ route('farmer-accompaniements.update', $farmerAccompaniement->id) }}" enctype="multipart/form-data">
                                @csrf
                                @method('PUT')
                                ...
                                <div class="card-body row">
                                    ...
                                    <div class="form-group col-md-3">
                                        ...
                                        <select name="year" class="form-control form-control-sm select2" data-show-subtext="true" data-live-search="true">
                                            ...
                                            @for ($year = now()->year; $year >= now()->year - 20; $year--)
                                                <option value="{{ $year }}" {{ $farmerAccompaniement->year == $year ? 'selected' : '' }}>
                                                    {{ $year }}
                                                </option>
                                            @endfor
                                        </select>
                                    ...
                                    <div class="form-group col-md-3">
                                        ...
                                        <select name="season" id="season" class="form-control form-control-sm select2" data-show-subtext="true" data-live-search="true">
                                            ...
                                            <option value="A" {{ $farmerAccompaniement->season == 'A' ? 'selected' : '' }}>A</option>
                                            <option value="B" {{ $farmerAccompaniement->season == 'B' ? 'selected' : '' }}>B</option>
                                        </select>
                                        @error('farmer_id')
                                    ...
                                    <div class="form-group col-md-3">
                                        ...
                                        <select name="farmer_id" id="farmer" class="form-control form-control-sm select2" data-show-subtext="true" data-live-search="true">
                                            ...
                                            @foreach ($viewData['farmers'] as $farmer)
                                                <option value="{{ $farmer->id }}" {{ $farmerAccompaniement->farmer_id == $farmer->id ? 'selected' : '' }}>
                                    ...
                                    <div class="form-group col-md-3">
                                        ...
                                        <input type="text" class="form-control" name="beneficiary_name" id="beneficiary_name" value="{{ old('beneficiary_name', $farmerAccompaniement->beneficiary_name) }}" placeholder="Full Name of the Beneficiary">
                                    ...
                                    <div class="form-group col-md-3">
                                        <label>Country</label>
                                        <input type="text" class="form-control" name="country" id="country" value="{{ old('country', $farmerAccompaniement->country) }}" placeholder="Country">
                                        @error('country')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="form-group col-md-3">
                                        ...
                                        <input type="text" class="form-control" name="province" id="province" value="{{ old('province', $farmerAccompaniement->province) }}" placeholder="Province/State">
                                        @error('province')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="form-group col-md-3">
                                        ...
                                        <input type="text" class="form-control" name="territory" id="territory" value="{{ old('territory', $farmerAccompaniement->territory) }}" placeholder="Territory">
                                        @error('territory')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="form-group col-md-3">
                                        ...
                                        <input type="text" class="form-control" name="groupement" id="groupement" value="{{ old('groupement', $farmerAccompaniement->groupement) }}" placeholder="Group Name">
                                        @error('groupement')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="form-group col-md-3">
                                        <label>Village</label>
                                        <input type="text" class="form-control" name="village" id="village" value="{{ old('village', $farmerAccompaniement->village) }}" placeholder="Village Name">
                                        @error('village')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="form-group col-md-3">
                                        <label>Gender</label>
                                        <input type="text" class="form-control" name="gender" id="gender" value="{{ old('gender', $farmerAccompaniement->gender) }}" placeholder="Gender">
                                        @error('gender')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="form-group col-md-3">
                                        <label>Age</label>
                                        <input type="number" class="form-control" name="age" id="age" value="{{ old('age', $farmerAccompaniement->age) }}" placeholder="Age">
                                        @error('age')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="form-group col-md-3">
                                        ...
                                        <input type="text" class="form-control" name="phone_number" id="phone_number" value="{{ old('phone_number', $farmerAccompaniement->phone_number) }}" placeholder="Contact Number">
                                        @error('phone_number')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="form-group col-md-3">
                                        <label>Site</label>
                                        <input type="text" class="form-control" name="site" value="{{ old('site', $farmerAccompaniement->site) }}" placeholder="Operational Site">
                                        @error('site')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="form-group col-md-3">
                                        ...
                                        <input type="text" class="form-control" name="gps_coordinates" id="gps_coordinates" value="{{ old('gps_coordinates', $farmerAccompaniement->gps_coordinates) }}" placeholder="Latitude, Longitude">
                                    ...
                                    <div class="form-group col-md-3">
                                        ...
                                        <input type="text" class="form-control" name="crop_sown" value="{{ old('crop_sown', $farmerAccompaniement->crop_sown) }}" placeholder="Type of Crop">
                                        @error('crop_sown')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="form-group col-md-3">
                                        <label>Variety</label>
                                        <input type="text" class="form-control" name="variety" value="{{ old('variety', $farmerAccompaniement->variety) }}" placeholder="Crop Variety">
                                        @error('variety')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="form-group col-md-3">
                                        ...
                                        <input type="number" step="0.01" class="form-control" name="seed_quantity_received" value="{{ old('seed_quantity_received', $farmerAccompaniement->seed_quantity_received) }}" placeholder="Quantity in Kg">
                                    ...
                                    <div class="form-group col-md-3">
                                        ...
                                        <input type="text" class="form-control" name="fertilizer_type" value="{{ old('fertilizer_type', $farmerAccompaniement->fertilizer_type) }}" placeholder="Type of Fertilizer">
                                    ...
                                    <div class="form-group col-md-3">
                                        ...
                                        <input type="number" step="0.01" class="form-control" name="fertilizer_quantity_base" value="{{ old('fertilizer_quantity_base', $farmerAccompaniement->fertilizer_quantity_base) }}" placeholder="Quantity in Kg">
                                    ...
                                    <div class="form-group col-md-3">
                                        ...
                                        <input type="number" step="0.01" class="form-control" name="fertilizer_quantity_surface" value="{{ old('fertilizer_quantity_surface', $farmerAccompaniement->fertilizer_quantity_surface) }}" placeholder="Quantity in Kg">
                                    ...
                                    <div class="form-group col-md-3">
                                        ...
                                        <input type="number" step="0.01" class="form-control" name="cultivated_area" value="{{ old('cultivated_area', $farmerAccompaniement->cultivated_area) }}" placeholder="Area in Square Meters">
                                    ...
                                    <div class="form-group col-md-3">
                                        ...
                                        <input type="number" class="form-control" name="training_sessions_received" value="{{ old('training_sessions_received', $farmerAccompaniement->training_sessions_received) }}" placeholder="Number of Sessions">
                                    ...
                                    <div class="form-group col-md-3">
                                        ...
                                        <textarea class="form-control" name="training_types_received" rows="3">{{ old('training_types_received', $farmerAccompaniement->training_types_received) }}</textarea>
                                    ...
                                    <div class="form-group col-md-3">
                                        ...
                                        <textarea class="form-control" name="additional_support_received" rows="3">{{ old('additional_support_received', $farmerAccompaniement->additional_support_received) }}</textarea>
                                    ...
                                    <div class="form-group col-md-3">
                                        ...
                                        <input type="number" step="0.01" class="form-control" name="quantity_produced" value="{{ old('quantity_produced', $farmerAccompaniement->quantity_produced) }}" placeholder="Quantity in Kg">
                                    ...
                                    <div class="form-group col-md-3">
                                        ...
                                        <input type="number" step="0.01" class="form-control" name="quantity_reimbursed" value="{{ old('quantity_reimbursed', $farmerAccompaniement->quantity_reimbursed) }}" placeholder="Quantity in Kg">
                                    ...
                                    <div class="form-group col-md-3">
                                        ...
                                        <textarea class="form-control" name="observations" rows="3">{{ old('observations', $farmerAccompaniement->observations) }}</textarea>
                                        @error('observations')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    </div>
