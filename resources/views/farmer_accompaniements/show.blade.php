    ...
    <div class="container">
        ...
        <div class="section basic-info">
            ...
            <div class="details">
                ...
                <div class="field"><label>Beneficiary Name:</label>
                    <span>{{ $farmerAccompaniement->beneficiary_name }}</span></div>
                ...
                <div class="field"><label>Phone Number:</label> <span>{{ $farmerAccompaniement->phone_number }}</span>
                </div>
            </div>
        ...
        <div class="section">
            ...
            <div class="field"><label>Crop Sown:</label> <span>{{ $farmerAccompaniement->crop_sown ?? 'N/A' }}</span>
            </div>
            <div class="field"><label>Variety:</label> <span>{{ $farmerAccompaniement->variety ?? 'N/A' }}</span></div>
            <div class="field"><label>Seed Quantity Received (Kg):</label>
                <span>{{ $farmerAccompaniement->seed_quantity_received ?? 'N/A' }}</span></div>
            <div class="field"><label>Fertilizer Type:</label>
                <span>{{ $farmerAccompaniement->fertilizer_type ?? 'N/A' }}</span></div>
            <div class="field"><label>Basal Quantity Fertilizer Received (Kg):</label>
                <span>{{ $farmerAccompaniement->fertilizer_quantity_base ?? 'N/A' }}</span></div>
            <div class="field"><label>Top-dressing Quantity Fertilizer Received (Kg):</label>
                <span>{{ $farmerAccompaniement->fertilizer_quantity_surface ?? 'N/A' }}</span></div>
            <div class="field"><label>Superficial Area Cultivated:</label>
                <span>{{ $farmerAccompaniement->cultivated_area ?? 'N/A' }}</span></div>
        </div>

        <!-- Training and Support Information -->
        <div class="section">
            <h2>Training and Support Information</h2>
            <div class="field"><label>Training Sessions Received:</label>
                <span>{{ $farmerAccompaniement->training_sessions_received ?? 'N/A' }}</span></div>
            <div class="field"><label>Types of Training Received:</label>
                <span>{{ $farmerAccompaniement->training_types_received ?? 'N/A' }}</span></div>
            <div class="field"><label>Additional Support Received:</label>
                <span>{{ $farmerAccompaniement->additional_support_received ?? 'N/A' }}</span></div>
        </div>

        <!-- Production Information -->
        <div class="section">
            <h2>Production Information</h2>
            <div class="field"><label>Quantity Produced (Kg):</label>
                <span>{{ $farmerAccompaniement->quantity_produced ?? 'N/A' }}</span></div>
            <div class="field"><label>Quantity Reimbursed (Kg):</label>
                <span>{{ $farmerAccompaniement->quantity_reimbursed ?? 'N/A' }}</span></div>
        </div>
        <!-- Footer -->
        <div class="footer">
