                                        ...
                                        <tbody>
                                            @foreach ($viewData['field_visits'] as $visit)
                                                <tr>
                                                    ...
                                                    <td>{{ $visit->field->farmer->last_name . ' ' . $visit->field->farmer->first_name . ' (' . $visit->field->field_name . ')' ?? 'N/A' }}
                                                    </td>
                                                    ...
                                                    <td>
                                                        @foreach(json_decode($visit->photos) as $photo)
                                                            <a href="{{ asset('storage/' . $photo) }}" target="_blank">
                                                                <img src="{{ asset('storage/' . $photo) }}" width="50" height="50"
                                                    ...
                                                    <td>
                                                        <div class="dropdown">
                                                            ...
                                                            <div class="dropdown-menu dropdown-menu-right">
                                                                <a href="{{ route('field_visits.show', $visit->id) }}"
                                                                    class="dropdown-item has-icon">
                                                                    <i class="far fa-eye text-info"></i> View
                                                                </a>
                                                                <a href="{{ route('field_visits.edit', $visit->id) }}"
                                                                    class="dropdown-item has-icon">
                                                                    <i class="far fa-edit text-success"></i> Edit
                                                                </a>

                                                                <form action="{{ route('field_visits.destroy', $visit->id) }}"
                                                                    method="post">
                                                                    @csrf
                                                                    @method('DELETE')
