                    ...
                    <div class="card">
                        <div class="card-header">
                            ...
                            <div class="card-header-action">
                                <a href="{{ route('territories.create') }}" class="btn btn-icon icon-left btn-success">
                                    ...
                                    <tbody>
                                        @foreach ($viewData['territories'] as $territory)
                                            <tr>
                                                ...
                                                <td>{{ $territory->province->country->name }}</td>
                                                <td>
                                                    <div class="dropdown">
                                                        <a href="#" class="dropdown-toggle btn btn-success" data-toggle="dropdown">Action</a>
                                                        <div class="dropdown-menu dropdown-menu-right">
                                                            {{-- <a target="_blank" href="{{ route('territories.show', $territory->id) }}" class="dropdown-item has-icon">
                                                                <i class="far fa-eye text-info"></i> View
                                                            </a> --}}
                                                            <a href="{{ route('territories.edit', $territory->id) }}" class="dropdown-item has-icon">
